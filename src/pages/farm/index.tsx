...
export default function Farm(): JSX.Element {
  ...
  const hardcodedPairs = { //todo: fix farms
    [ChainId.SMARTBCH]: {
      ...
      //   farmId: 19,
      //   allocPoint: 5923315,
      //   token0: new Token(ChainId.SMARTBCH, '0xdB9efDae281BCFF410d64FEB62D8f27D907745E3', 18, 'XHONK', 'HONKbar'), //todo: update with honkbar
      //   token1: WBCH[ChainId.SMARTBCH],
      // },
      ...
      //   allocPoint: 6841696,
      //   token0: HONK[ChainId.SMARTBCH],
      //   token1: new Token(ChainId.SMARTBCH, '0xdB9efDae281BCFF410d64FEB62D8f27D907745E3', 18, 'XHONK', 'HONKbar'), //todo: update with honkbar
      // },
