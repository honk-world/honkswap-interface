...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@honkswapdex/sdk'
...
export default function Add() {
  ...
  async function onAdd() {
    ...
    try {
      ...
      // const estimatedGasLimit = BigNumber.from(305000);
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Honk</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the HONKswap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
