...
export default function Stake() {
  ...
  const [approvalState, approve] = useApproveCallback(parsedAmount, BAR_ADDRESS[ChainId.SMARTBCH])
    ...
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Stake MIST in return for xMIST, an interest bearing and fungible ERC20 token designed to share revenue generated by all MIST products."
        />
        ...
        <meta
          ...
          content="Stake MIST in return for xMIST, an interest bearing and fungible ERC20 token designed to share revenue generated by all MIST products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.mistswap.fi/xsushi-sign.png" />
        ...
        <meta key="og:image" property="og:image" content="https://app.mistswap.fi/xsushi-sign.png" />
        <meta
          key="og:description"
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          ...
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xsushi-sign.png" alt="xMIST sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
