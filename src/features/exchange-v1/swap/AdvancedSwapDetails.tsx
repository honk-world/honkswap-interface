import { ChainId, Currency, CurrencyAmount, SmartBCH, Percent, TradeType, Trade as V2Trade } from '@honkswapdex/sdk'
...
export function AdvancedSwapDetails({ trade, allowedSlippage, minerBribe }: AdvancedSwapDetailsProps) {
  ...
  return !trade ? null : (
    <div className="flex flex-col space-y-2">
      ...
      <RowBetween>
        <RowFixed>
          <div className="text-sm text-secondary">{i18n._(t`xHONK Fee`)}</div>
          <QuestionHelper
            text={i18n._(t`A portion of each trade (0.05%) goes to xHONK holders as a protocol incentive.`)}
          />
        </RowFixed>
        <div className="text-sm font-bold text-high-emphesis">
